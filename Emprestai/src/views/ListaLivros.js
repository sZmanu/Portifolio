...
import Card from "../componentes/CardLivro";
import Recobrir from "../componentes/CadastrarLivro";
...
const ListaLivros = () => {
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1, backgroundColor: '#F5F5DC'}} style={{ flex: 1,paddingBottom: 80 }}>
        ...
        <View style={{width: '100%', height: 50, backgroundColor: '#1E3A8A', position: 'absolute',top: 0, zIndex: 2}}></View>
        ...
        <Text style={styles.title2}>e Livros</Text>
        </View>
        <Recobrir/>
